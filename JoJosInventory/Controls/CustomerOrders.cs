...
namespace JoJosInventory.Controls
{
    public partial class CustomerOrders : UserControl
    {
        ...
        public CustomerOrders()
        {
            ...
            searchFilters();
            cmbCustomer.DataSource = lookup.RawCategories;
            cmbOrderNumber.DataSource = lookup.RawSku;            
        ...
        private void FilterDgv()
        {
            ...
            //dt.DefaultView.RowFilter = "NAME LIKE '%" + cmbCategory.Text + "%' AND Sku LIKE '%" + cmbSku.Text + "%'";
        }
        ...
        {
            dpDate.Enabled = chkDate.Checked;
            FilterDgv();
        }
    }
}
