...
namespace JoJosInventory.Controls
{
    public partial class BaseMaterial : UserControl
    {
        ...
        private void searchFilters()
        {
            ...
            bc = Raw.BaseMaterialSearch("", null, "");
            if (!bc.error)
            {
                Formatdgv();
                FilterDgv();
        ...
        {
            string s = "";
            if (chkDue.Checked) s = " AND DueDate = '" + dpDate.Text + "'";
            dt.DefaultView.RowFilter = "NAME LIKE '%" + cmbCategory.Text + "%' AND Sku LIKE '%" + cmbSku.Text + "%'" + s;
        }
